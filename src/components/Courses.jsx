    ...
    render() {
        return (
            <section id="Courses">
                <header>
                    <h3>Our Courses</h3>
                    <p>Aligned with our vision to focus our efforts on the developer community - and the organizations they are affiliated with - we offer two specific education tracks:</p>
